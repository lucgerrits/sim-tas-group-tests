...
set title "Commits for 6 to 24 nodes"
...
plot "data.csv" using 1:2 with linespoints pt 12 pi 0 title "6 nodes", \
    "data.csv" using 1:3 with linespoints pt 3 pi 0 title "12 nodes", \
    "data.csv" using 1:4 with linespoints pt 5 pi 0 title "18 nodes", \
    "data.csv" using 1:5 with linespoints pt 10 pi 0 title "24 nodes"